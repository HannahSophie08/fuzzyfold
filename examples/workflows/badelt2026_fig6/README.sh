...
cat dld2_lm4.na | ff-timecourse --rna turner2004 --macrostates dld2*.ms --k0 1e5 --k3ws 0 --k4ws 0 --t-sep 0.1 --t-end 100 -n 100 --output dld2_lm4_t100_k0_1e5_k3ws_0_k4ws_0
cat dld2_lm4.na | ff-timecourse --rna turner2004 --macrostates dld2*.ms --k0 1e5 --k3ws 1e4 --k4ws 0 --t-sep 0.1 --t-end 100 -n 100 --output dld2_lm4_t100_k0_1e5_k3ws_1e4_k4ws_0
cat dld2_lm4.na | ff-timecourse --rna turner2004 --macrostates dld2*.ms --k0 1e5 --k3ws 1e4 --k4ws 1e4 --t-sep 0.1 --t-end 100 -n 100 --output dld2_lm4_t100_k0_1e5_k3ws_1e4_k4ws_1e4
